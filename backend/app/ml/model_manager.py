...
class ARIMAForecaster:
    ...
    def fit(self, data: pd.DataFrame, target_column: str = "y", exogenous: Optional[List[str]] = None):
...
class XGBoostForecaster:
    ...
    def _create_lag_features(self, y: pd.Series, exogenous: Optional[pd.DataFrame] = None) -> Tuple[np.ndarray, np.ndarray]:
